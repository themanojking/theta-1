...
const Developers = () => {
    const developers = [
        ...
        { name: 'Manirathnam', role: 'Frontend Developer', description: 'A passionate coder focused on creating interactive and user-friendly interfaces.', image: '/Assets/mani.png', github: '', linkedin: 'https://www.linkedin.com/in/manirathnam08', instagram: 'https://www.instagram.com/mani__08_' },
